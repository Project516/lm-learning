# hard_mode.py - Tournament of old brains vs a chasing ghost
#
# Task 1: Train a fresh Q-table on the hard world (chasing ghost)
# Task 2: Test all three easy-world agents on hard mode
